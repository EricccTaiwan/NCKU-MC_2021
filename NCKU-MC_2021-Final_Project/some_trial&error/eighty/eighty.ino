...
void loop() {
  ...
  if(side_r>black and side_l>black and (time/1000)<60){
      go_straight();
      delay(50);
      go_right();//中右黑
      delay(200);
    ...
    else if(cm_f<50 and cm_f>40 and middle_l<black and middle_r<black and side_l<black and side_r<black ){ //倒車入庫
      while(1){//自轉
          go_stop();
          delay(50);
          int middle_r=analogRead(A3);
      ...
      cross==8;
        ...
        else if(side_r>black and ( middle_r>black or middle_l>black) and side_l<black and cross==8 and (time/1000)<90){
      while(1){
      go_stop();//岔路out
      delay(10);
      analogWrite(11,80);
